...
<div class="bg-gray-900 px-20 py-16 rounded-lg mb-8 relative overflow-hidden">
  ...
  <img src="{{ asset('images/dev.png') }}" class="absolute -right-6 -bottom-28 opacity-50">
</div>
...
<div class="px-4">
  ...
  <div class="grid grid-cols-1 gap-4 mb-4">
    ...
    <a href="{{ route('post', $post -> slug) }}" class="bg-gray-100 rounded-lg px-6 py-4">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="currentColor" className="size-6">
